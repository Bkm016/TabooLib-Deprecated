...
public class TagPlayerData {
    ...
    public io.izzel.taboolib.util.tag.TagPlayerData reset() {
    ...
    public io.izzel.taboolib.util.tag.TagPlayerData setNameVisibility(boolean nameAllow) {
        this.nameAllow = nameAllow;
        return this;
    }

    public io.izzel.taboolib.util.tag.TagPlayerData setNameDisplay(String nameDisplay) {
        this.nameDisplay = nameDisplay.length() > 16 ? nameDisplay.substring(0, 16) : nameDisplay;
        return this;
    }

    public io.izzel.taboolib.util.tag.TagPlayerData setPrefix(String prefix) {
        this.prefix = prefix.length() > 16 ? prefix.substring(0, 16) : prefix;
        return this;
    }

    public io.izzel.taboolib.util.tag.TagPlayerData setSuffix(String suffix) {

...
public class BookBuilder {
     ...
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder title(String title) {
        meta.setTitle(title);
        return this;
    }
     ...
     * @return the BookBuilder's calling instance
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder author(String author) {
     ...
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder generation(BookMeta.Generation generation) {
     ...
     * @return the BookBuilder's calling instance
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder pagesRaw(String... pages) {
        meta.setPages(pages);
        return this;
    }
     ...
     * @return the BookBuilder's calling instance
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder pagesRaw(List<String> pages) {
        meta.setPages(pages);
        return this;
    }
     ...
     * @return the BookBuilder's calling instance
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder pages(BaseComponent[]... pages) {
     ...
     * @return the BookBuilder's calling instance
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder pages(List<BaseComponent[]> pages) {
        BookAsm.getHandle().setPages(meta, pages.toArray(new BaseComponent[0][]));
        return this;
    }

    public io.izzel.taboolib.util.book.builder.BookBuilder addPage(TellrawJson json) {
     ...
     * @return the BookBuilder's calling instance
     */
    public io.izzel.taboolib.util.book.builder.BookBuilder addPages(BaseComponent[]... pages) {
    ...
    public io.izzel.taboolib.util.book.builder.BookBuilder open(Player... players) {

...
public interface HoverAction {
     ...
     */
    static io.izzel.taboolib.util.book.action.HoverAction showText(BaseComponent... text) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showText(String text) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showItem(BaseComponent... item) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showItem(ItemStack item) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showEntity(BaseComponent... entity) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showEntity(UUID uuid, String type, String name) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showEntity(Entity entity) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showAchievement(String achievementId) {
     ...
     * @return a new HoverAction instance
     */
    static io.izzel.taboolib.util.book.action.HoverAction showStatistic(String statisticId) {
    ...
    class SimpleHoverAction implements io.izzel.taboolib.util.book.action.HoverAction {

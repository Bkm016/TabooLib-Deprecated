...
public interface ClickAction {
     ...
     */
    static io.izzel.taboolib.util.book.action.ClickAction runCommand(String command) {
     ...
     * @return a new ClickAction
     */
    static io.izzel.taboolib.util.book.action.ClickAction suggestCommand(String command) {
     ...
     * @return a new ClickAction
     */
    static io.izzel.taboolib.util.book.action.ClickAction openUrl(String url) {
     ...
     * @return a new ClickAction
     */
    static io.izzel.taboolib.util.book.action.ClickAction changePage(int page) {
    ...
    class SimpleClickAction implements io.izzel.taboolib.util.book.action.ClickAction {
